...
- GitLab Issue publication, archived Push completion, and controlled abandoned-label cancellation are built-in Flow templates, preserving publication, `done`, `cancelled`, and linked-Issue closure semantics while moving execution through one runtime.

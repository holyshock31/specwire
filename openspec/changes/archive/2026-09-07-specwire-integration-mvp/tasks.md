...
- [x] 6.7c Preserve immutable published completion model versions when bootstrapping an existing database; register the cancellation model/behavior separately and reconcile the reserved abandon Flow and route on restart.

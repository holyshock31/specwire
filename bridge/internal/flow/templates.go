...
func abandonGraph() domain.FlowGraph {
	return domain.FlowGraph{Nodes: []domain.FlowNode{
		...
		}}, Generic: &domain.GenericNode{Type: GenericMappingTemplate, ParameterBindings: map[string]domain.ParameterBinding{"model": {Kind: domain.BindingFixed, Value: "MulticaCancelIssueInput.v1"}}}},
		{ID: "multica-cancel", Kind: domain.NodeConnector, Name: "Multica Cancel Issue", Inputs: []domain.Port{{ID: "cancel-input", Direction: domain.PortInput, ModelRef: "MulticaCancelIssueInput.v1", Required: true}}, Connector: &domain.ConnectorNode{BehaviorKey: "multica.cancel-issue", BehaviorVersion: "1.0.0", ParameterBindings: map[string]domain.ParameterBinding{"project": {Kind: domain.BindingConnectionRef, Ref: "$connection.target_project"}}}},
	}, Edges: []domain.FlowEdge{{ID: "edge-abandon-parse", FromNodeID: "gitlab-abandon-input", FromPortID: "event", ToNodeID: "parse-lifecycle", ToPortID: "event"}, {ID: "edge-lifecycle-map", FromNodeID: "parse-lifecycle", FromPortID: "lifecycle", ToNodeID: "map-cancel", ToPortID: "lifecycle"}, {ID: "edge-map-cancel", FromNodeID: "map-cancel", FromPortID: "cancel-input", ToNodeID: "multica-cancel", ToPortID: "cancel-input"}}}
}

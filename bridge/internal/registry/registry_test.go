...
func TestLoadBuiltins(t *testing.T) {
	...
	if len(bundle.Behaviors) != 6 {
		t.Fatalf("behaviors = %d, want 6", len(bundle.Behaviors))
	}
	if len(bundle.DataModels) != 6 {
		t.Fatalf("data models = %d, want 6", len(bundle.DataModels))
	}
